...
public abstract class Tree implements Cloneable {
	...
	public String toString(double weight, int indentationLevel) {
		return toString(weight, indentationLevel, null, 0);
	}
	
	public String toString(double weight, int indentationLevel, String type, int nb_factors) {
		String linePrefix = "";
		...
		if(type != null) 
			sb.append("\n" + linePrefix + "<Tree type=\""+type+"\" factors=\"" + nb_factors+"\" leaves=\"" + numLeaves + "\" weight=\"" + weight + "\">");
