...
public class BinaryFileGenerator {
	...
	protected int[][] valueDistributions;
	private int[] totalCount;
	protected NumericArray[] bins;

	protected double[] targets;
	protected Feature[] features;

	protected FeatureAnalyzer featureAnalyzer;
	...
	protected void loadValueHashMaps() {
		...
		try{
			...
			System.out.println("Error has occured during loading values at line "+instanceCount+" of file "+textFile+". Details are:");
