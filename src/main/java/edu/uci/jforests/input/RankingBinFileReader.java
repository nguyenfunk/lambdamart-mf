...
public class RankingBinFileReader extends BinaryFileReader {
	...
	private int[] queryBoundaries, docBoundaries, qdLines;
	private int[] queryIdx, docIdx;
	...
	protected void readHeader() throws Exception {
		...
		queryIdx = new int[readInt()];
		docIdx = new int[readInt()];
		docBoundaries = new int[readInt()];
		qdLines = new int[readInt()];
	}
